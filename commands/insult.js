const insults = [
    ...
    "Uko sure hukunyonga pia akili yako man.",
    ...
    "Yoh bana acha kuabisha wakisii beyond measure, tulishakubali hamna akili usiongeze mengine.",
    "This nonsense could be avoided by a condom.",
    "You have something unique—your ability to annoy everyone equally.",
    "Which village did you hail from idiot?.",
    "You're proof that not everyone needs a filter to be unappealing.",
    "Wajua tofauti yako na nguruwe ni keja.",
    "Shida yako ni kutumia akili kama dispenser ya kamasi.",
